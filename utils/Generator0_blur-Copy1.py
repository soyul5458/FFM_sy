        ...
        if self.ranfilter :   ## ex ranfilter = [10,11,12,13,14,15]
            ...
            for i in range(self.batch_size) :
                if dec1[i] == 1 :
                    ...
                    loc1 = np.random.choice(nf - b1, size = 1)[0]
                    nX[i, loc1:(loc1 + b1 - 1), :] = nX[i, loc1:(loc1 + b1 - 1), :] * 0.01
        ...
        if self.dropblock :  ## ex dropblock = [30, 80]
            ...
            for i in range(self.batch_size) :
                if dec1[i] == 1 :
                    ...
                    nX[i, loc1:(loc1 + b1 - 1), loc2:(loc2 + b2 - 1)] = nX[i, loc1:(loc1 + b1 - 1), loc2:(loc2 + b2 - 1)] * 0.01
            ...
            for i in range(self.batch_size) :
                if dec1[i] > 0 :
                    for j in range(dec1[i]) :
                        ...
                        loc1 = np.random.choice(nf - b1, size = 1)[0]
                        nX[i, loc1:(loc1 + b1 - 1), :] = nX[i, loc1:(loc1 + b1 - 1), :] * 0.001
